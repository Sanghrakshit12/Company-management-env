...
class analog : public type{
    ...
    friend void operator + (analog &ana,int n);
};
...
class digital : public type{
    ...
    string extra[20]={"MEN","MEN","UNISEX"};    //friend 
    friend void bill(digital &digi);
    friend void operator + (digital &digi);
};
class chronograph : public type{
    ...
    friend void operator + (chronograph &chrono);
};
...
void operator + (analog &ana,int n){
    int q;
    cout << "How many to add : ";
    cin >> q;
    ana.num_of_device[n]=ana.num_of_device[n] + q;
    cout << "The quantity of vehicles is " << ana.num_of_device << endl;
    //ana.num_of_device = ana.num_of_device + 1;
    //return ana.num_of_device;
    //cout<<ana.num_of_device<<endl;
}
...
void customerdata(string name, long int ph){
    ...
    cout << "\t\t	//////////////////////////////////////////////////////"<<endl;
    cout <<setw(5)<< "\t\t	| Invoice No. :"<<"------------|"<<"#"<<rand()*23<<setw(5)<<endl;
    cout <<setw(5)<< "\t\t	| Customer Name:"<<"-----------|"<<name<<endl;
    cout <<setw(5)<< "\t\t	| Phone no :"<<"---------------|"<<ph<<endl;
}
void bill(analog &ana,int i){ 
    cout <<setw(5)<< "\t\t	| Product ID :"<<"-------------|"<<ana.product_id[i]<<endl;
    cout <<setw(5)<< "\t\t	| Model name :"<<"-------------|"<<ana.model[i]<<endl;
    cout <<setw(5)<< "\t\t	| Code no :"<<"----------------|"<<ana.num_of_device[i]<<endl;
    cout <<setw(5)<< "\t\t	| Price :"<<"------------------|"<<ana.price[i]<<endl;
    cout <<setw(5)<< "\t\t	| GST :"<<"--------------------|"<<67<<" $"<<endl;
    cout << "\t\t	 ___________________________________________________"<<endl;
    cout <<"\n";
    cout <<setw(5)<< "\t\t	| Total Amount is :"<<"-------|"<<setw(10)<<ana.price[i]+67<<" $"<<" |"<<endl;
}
void bill(digital &digi,int i){ 
    cout <<setw(5)<< "\t\t	| Product ID :"<<"-------------|"<<digi.product_id[i]<<endl;
    cout <<setw(5)<< "\t\t	| Model name :"<<"-------------|"<<digi.model[i]<<endl;
    cout <<setw(5)<< "\t\t	| Code no :"<<"----------------|"<<digi.num_of_device[i]<<endl;
    cout <<setw(5)<< "\t\t	| Price :"<<"------------------|"<<digi.price[i]<<endl;
    cout <<setw(5)<< "\t\t	| GST :"<<"--------------------|"<<67<<" $"<<endl;
    cout << "\t\t	 ___________________________________________________"<<endl;
    cout <<"\n";
    cout <<setw(5)<< "\t\t	| Total Amount is :"<<"-------|"<<setw(10)<<digi.price[i]+67<<" $"<<" |"<<endl;
}
void bill(chronograph &chrono,int i){ 
    cout <<setw(5)<< "\t\t	| Product ID :"<<"-------------|"<<chrono.product_id[i]<<endl;
    cout <<setw(5)<< "\t\t	| Model name :"<<"-------------|"<<chrono.model[i]<<endl;
    cout <<setw(5)<< "\t\t	| Code no :"<<"----------------|"<<chrono.num_of_device[i]<<endl;
    cout <<setw(5)<< "\t\t	| Price :"<<"------------------|"<<chrono.price[i]<<endl;
    cout <<setw(5)<< "\t\t	| GST :"<<"--------------------|"<<67<<" $"<<endl;
    cout << "\t\t	 ___________________________________________________"<<endl;
    cout <<"\n";
    cout <<setw(5)<< "\t\t	| Total Amount is :"<<"-------|"<<setw(10)<<chrono.price[i]+67<<" $"<<" |"<<endl;
}
void bill(smart &smart,int i){ 
    cout <<setw(5)<< "\t\t	| Product ID :"<<"-------------|"<<smart.product_id[i]<<endl;
    cout <<setw(5)<< "\t\t	| Model name :"<<"-------------|"<<smart.model[i]<<endl;
    cout <<setw(5)<< "\t\t	| Code no :"<<"----------------|"<<smart.num_of_device[i]<<endl;
    cout <<setw(5)<< "\t\t	| Price :"<<"------------------|"<<smart.price[i]<<endl;
    cout <<setw(5)<< "\t\t	| GST :"<<"--------------------|"<<67<<" $"<<endl;
    cout << "\t\t	 ___________________________________________________"<<endl;
    cout <<"\n";
    cout <<setw(5)<< "\t\t	| Total Amount is :"<<"-------|"<<setw(10)<<smart.price[i]+67<<" $"<<" |"<<endl;
}
void bill(men &m,int i){ 
    cout <<setw(5)<< "\t\t	| Product ID :"<<"-------------|"<<m.product_id[i]<<endl;
    cout <<setw(5)<< "\t\t	| Model name :"<<"-------------|"<<m.model[i]<<endl;
    cout <<setw(5)<< "\t\t	| Code no :"<<"----------------|"<<m.num_of_device[i]<<endl;
    cout <<setw(5)<< "\t\t	| Price :"<<"------------------|"<<m.price[i]<<endl;
    cout <<setw(5)<< "\t\t	| GST :"<<"--------------------|"<<67<<" $"<<endl;
    cout << "\t\t	 ___________________________________________________"<<endl;
    cout <<"\n";
    cout <<setw(5)<< "\t\t	| Total Amount is :"<<"-------|"<<setw(10)<<m.price[i]+67<<" $"<<" |"<<endl;
}
void bill(women &wo,int i){ 
    cout <<setw(5)<< "\t\t	| Product ID :"<<"-------------|"<<wo.product_id[i]<<endl;
    cout <<setw(5)<< "\t\t	| Model name :"<<"-------------|"<<wo.model[i]<<endl;
    cout <<setw(5)<< "\t\t	| Code no :"<<"----------------|"<<wo.num_of_device[i]<<endl;
    cout <<setw(5)<< "\t\t	| Price :"<<"------------------|"<<wo.price[i]<<endl;
    cout <<setw(5)<< "\t\t	| GST :"<<"--------------------|"<<67<<" $"<<endl;
    cout << "\t\t	 ___________________________________________________"<<endl;
    cout <<"\n";
    cout <<setw(5)<< "\t\t	| Total Amount is :"<<"-------|"<<setw(10)<<wo.price[i]+67<<" $"<<" |"<<endl;
}
void output(){
    cout << "\t\t	 ___________________________________________________"<<endl;
